...
public class BasicExample {
    ...
    private static final int VECTOR_SIZE = 10_000;
    private static final int RANDOM_MAX_NUMBER = 100;
    private static final int RANDOM_MIN_NUMBER = 30;
    private static final int ITERATION_COUNT = 1000;
    private static final int THREADS_COUNT = 4;
    private static final int BATCH_SIZE_THREAD_POOL = 1000;
    private static final int BATCH_SIZE_FORK_JOIN_POOL = 1000;
    ...
    private static RunContext createRunContext() {
        ...
        return new RunContext(ITERATION_COUNT, THREADS_COUNT, numberToFind, vector, BATCH_SIZE_THREAD_POOL, BATCH_SIZE_FORK_JOIN_POOL, EXPORT_FILE_NAME);
    }
